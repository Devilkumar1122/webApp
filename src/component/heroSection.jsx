...
export function HeroSection(){
    return(
        <section className='relative overflow-hidden bg-gradient-to-br from-purple-50 via-blue-50 to bg-indigo-100'>
            {/* Main Hero Section  */}
            <div className='grid grid-cols-2 gap-12 space-y-10 items-center px-4 pt-20 pb-32'>
                ...
                <div className=''>
                    ...
                    <div>
                        ...
                        <h1 className='mt-4 mb-4 text-7xl font-bold'>
                        ...
                        <p className='text-gray-500 text-2xl leading-relaxed max-w-lg'>Discover authentic mobile accessories, genuine spare parts, and expert repair services. Quality
                    ...
                    <div className='flex gap-5 mt-8 mb-4 '>
                        ...
                        <button className='px-12 py-2 font-semibold bg-white hover:bg-gradient-to-r from-purple-100 to-blue-200 text-lg hover:text-purple-600 text-black outline-none border-1 border-gray-200 rounded-md'>
                            Repair Services
                        </button>
                    </div>
