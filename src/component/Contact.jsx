...
export default function Contact() {
  return (
    <section className="pt-48 pb-8 bg-gradient-to-br from-gray-50 to bg-gray-100">
      <div className="max-w-7xl mx-auto px-8 py-2 bg-gradient-to-br from-purple-50 via-blue-50 to bg-indigo-100 rounded-xl border">
        {/* Heading */}
        <div className="text-center mt-3 mb-10">
          <h2 className="text-4xl font-bold text-gray-900 mb-3">Contact Us</h2>
          <p className="text-gray-600 text-lg">We’d love to hear from you! Fill out the form or reach us using the details below.</p>
        </div>

        {/* Main Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white p-8 rounded-xl shadow-lg mb-4">
          {/* Left Side - Form */}
          ...
          <div className="flex flex-col justify-center space-y-6 bg-gradient-to-r from-purple-600 to-blue-600 text-white p-8 rounded-xl">
