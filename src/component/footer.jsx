          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                <div className="bg-gradient-to-br from-purple-600 to-blue-600 text-white p-3 rounded-xl">
                  <span className="font-bold text-xl">KK</span>
                </div>
                <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold">info@kkmobile.com</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <p className="text-gray-400 text-center lg:text-left">
              © 2024 KK Mobile Centre. All rights reserved. | Designed with ❤️ for mobile enthusiasts
            </p>
