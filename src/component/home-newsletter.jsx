          ...
          <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto mb-8">
              <input
                ...
                className="bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder:text-blue-200 focus:bg-white/20 px-3 pr-16 rounded-md outline-none"
                required
              />
              <button type="submit" className="bg-white text-purple-600 hover:bg-blue-50 font-bold text-lg px-10 py-3 rounded-md">
                Subscribe Now
              </button>
            </form>
