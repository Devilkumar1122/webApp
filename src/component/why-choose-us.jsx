            ...
            <div className='grid grid-cols-3 gap-6'>
                {features.map((item)=>{
                    ...
                    return(
                        ...
                        <div key={item.title} className={clsx(`flex flex-col items-start group p-8 rounded-2xl bg-gray-50 ${item.hoverColor} hover:shadow-2xl  transition-all duration-300 hover:-translate-y-1 border border-gray-100`)}>
